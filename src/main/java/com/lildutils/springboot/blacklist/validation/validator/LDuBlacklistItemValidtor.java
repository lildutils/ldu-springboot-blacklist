package com.lildutils.springboot.blacklist.validation.validator;
...
@Component
public class LDuBlacklistItemValidtor
{
	...
	public <T> void validate( T dto )
	{
		...
		{
			throw new LDuBlacklistItemValidationException( validationErrors );
		}
	}
